...
const allCards: DemoCardData[] = [
  ...
  },
  {
    ...
    description: "A bolder take on the royal aesthetic with deeper crimson, golden shimmer accents and cinematic scroll animations.",
    price: "₹1,499",
  ...
  },
  {
    ...
    description: "The original classic design with floating lanterns, animated name reveal and scroll-driven storytelling.",
    price: "₹1,499",
  ...
  },
  {
    ...
    description: "The extended royal Marathi edition with additional illustrations and enhanced scroll transitions.",
    price: "₹1,499",
